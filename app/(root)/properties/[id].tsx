                ...
                <View className='px-5 mt-7 flex gap-2'>
                        ...
                        {property?.facilities.length > 0 && (
                            <View className='flex flex-row flex-wrap items-start justify-start mt-2 gap-5'>
                                {property?.facilities.map((item: string, index: number) => {
                                    ...
                                    return (
                                        <View key={index} className='flex flex-1 flex-col items-center min-w16 max-w-20'>
                    ...
                    {property?.gallery.length > 0 && (
                        <View className='mt-7'>
                            ...
                            <FlatList contentContainerStyle={{ paddingRight: 20 }} data={property?.gallery} keyExtractor={(item) => item.$id} horizontal showsHorizontalScrollIndicator={false} renderItem={({ item }) => (
